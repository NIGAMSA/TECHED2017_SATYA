sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("default/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("default.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["default/localService/mockserver"], function (mockserver) {
